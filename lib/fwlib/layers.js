...
define([
    ...
    utils
        ...
        var layers = {
            ...
            /**
             ...
             @param {DOM} [dom=currentDOM] The document to get elements from.  If this isn't included, the current document is
             used as the source.
             @param {boolean} includeWebLayers Include Web Layers.
             @returns {Element[]}
             @memberof module:layers
             */
            getElements: function(dom, includeWebLayers) {
                var data = layers.getElementData(dom, includeWebLayers);
    ...
    */
    ...
    LayerTree.prototype = /** @lends module:layers.LayerTree.prototype */ {
        ...
        */
         ...
         */
        get elementData() {
            return getElementDataFromElements(this.elements);
        },
    ...
    */
    ...
    /**
     ...
     @memberof module:layers
     */
    layers.getElements = function(dom, includeWebLayers) {
        var data = layers.getElementData(dom, includeWebLayers);
        return data.elements;
    };
    ...
    /**
     ...
     @param {Fw.FwDocument|Element[]} [elementsOrDom=currentDOM] An Element array, or the document to get elements from.  If this isn't included, the current document is used as the source.
     @param {boolean} includeWebLayers Include Web Layers. Ignored if element array is explicitly passed as first argument.
     @returns {LayerElementData}
     @memberof module:layers
     */
    layers.getElementData = function(elementsOrDom, includeWebLayers) {
        if (typeof elementsOrDom !== 'undefined' && utils.isArray(elementsOrDom)) {
            return getElementDataFromElements(elementsOrDom);
        }
        var tree = new layers.LayerTree(elementsOrDom, includeWebLayers !== true);
        return tree.elementData;
    };
