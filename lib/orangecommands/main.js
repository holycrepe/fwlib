...
// a collection of (hopefully) useful tools for Fireworks
            ...
            Page.copySymbols = function(options) {
                var symbolNames = _.map(Page.symbolInfo, 'name');
                utils.log("Copying " + symbolNames.length + " Symbols to New Pages: \n\t - " + symbolNames.join("\n\t - "));
                ...
                getSymbol:    function (element, options) {
                    ...
                    if (options.synchronizeNames) {
                        if (hasSameName) {
                            ...
                            utils.log("Renaming " + symbol.elementName + " to " + symbol.name);
