...
define([
    ...
    /**
     *
     * @param {SvgOpenFileOptions|string|boolean} [value]
     * @return {SvgOpenFileOptions}
     */
    function getSvgOptions(value) {
     ...
     * @return {SvgOpenFileOptions}
     */
    function processSvgOptions(value) {
        /** @type {SvgOpenFileOptions} **/
        var options = getSvgOptions(value);
        if (!options.path && options.prompt) {
            options.path = chooseSVGFile();
        }
        return options;
    }
    ...
    return /** @lends module:svg-file */ {
        ...
        /**
         *
         * @param {SvgOpenFileOptions|string|boolean} [options]
         * @param {Fw.FwDocument} [dom]
         * @return {Fw.FwElement|undefined}
         */
        insert:        function (options, dom) {
            ...
            /** @type {SvgOpenFileOptions} **/
            options = processSvgOptions(options);
        ...
        open: function (options) {
            ...
            if (!path)
                return;
            var dom       = fw.createFireworksDocument(
                    { x: 500, y: 500 },
                    { pixelsPerUnit: 72, units: "inch" },
                    "#ffffff"
                ),
